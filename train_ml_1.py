...
plt.savefig('plot_nm300.png', dpi=300)
plt.show()
...
model.save('model_ml_1.keras')

# Save input and predictions
np.save('y_test.npy',y_test)
np.save('predictions.npy',predictions)
np.save('idorg_train.npy',idorg_train)
np.save('idorg_val.npy',idorg_val)
np.save('idorg_test.npy',idorg_test)
np.save('ss_train.npy',ss_train)
np.save('ss_val.npy',ss_val)
np.save('ss_test.npy',ss_test)